    ...
    <Box>
      ...
      <Box sx={{ mb: 4, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <Button
          variant="contained"
          color="primary"
          startIcon={!isFetchingDaily && <CloudDownloadIcon />}
          ...
          sx={{ 
            ...
            '&.Mui-disabled': {
              ...
              // Add a subtle effect to indicate it's disabled
        ...
        >
          {isFetchingDaily && (
            <CircularProgress 
              ...
              sx={{ 
                mr: 1.5,
                color: theme.palette.primary.contrastText // Ensure spinner is visible too
              }} 
            />
          )}
          {isFetchingDaily ? 'Fetching...' : 'Fetch'}
        </Button>
      </Box>
